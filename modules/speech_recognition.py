...
class SpeechRecognition:
    ...
    def _validate_whisper_setup(self):
        ...
        if not os.path.exists(self.model_path):
            ...
            logger.info("You need to download the model file: ggml-large-v3-turbo-q5_0.bin")
    ...
    def save_audio_to_file(self, audio_data: np.ndarray, file_path: str, sample_rate: int = 16000):
    ...
    def transcribe_audio_file(self, audio_file_path: str) -> str:
        ...
        try:
            ...
            cmd = [
                ...
                "-f", audio_file_path,
                "--output-txt",
                "--output-file", audio_file_path.replace('.wav', '')
            ]
    ...
    def is_whisper_available(self) -> bool:
        ...
        return os.path.exists(self.whisper_executable) and os.path.exists(self.model_path)
